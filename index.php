...
<?php } else {
    ...
    <form id="form" method="POST" action="php/devmarkt.inc.php">
        ...
        <textarea oninput="checkInput('<?php echo getenv("BOT_BASE_URI") . '/strlen.php'; ?>')" id="desc" name="beschreibung" class="beschreibung" minlength="100" maxlength="4096" required></textarea>
        <p id="length"></p>
